...
class BoardAdapter(fm: FragmentManager,
    ...
    private val listBoarding = arrayOf(
        ...
        BoardModel(R.drawable.img2,"Share your crazy idea ^_^","You can easily share with your report, list or schedule and it's convenient",
            false
        ),
        BoardModel(R.drawable.img3, "Flexibility",
